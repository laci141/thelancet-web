...
#   ./vendor-cli.sh
#   ./vendor-cli.sh "/c/Users/LACI/Desktop/printing-press-library/library/developer-tools/thelancet"
set -euo pipefail
CLI_SRC="${1:-/c/Users/LACI/Desktop/printing-press-library/library/developer-tools/thelancet}"
